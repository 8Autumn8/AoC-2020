...
class Main {
  public static void main(String[] args) {
    ...
    for (int i = 0; i < 1000; i++){
      ...
      if ((pass.substring(min,min+1).equals(special_char) && !pass.substring(max,max+1).equals(special_char)) || (!pass.substring(min,min+1).equals(special_char) && pass.substring(max,max+1).equals(special_char))){
        numValidPass++;
      }
    }
